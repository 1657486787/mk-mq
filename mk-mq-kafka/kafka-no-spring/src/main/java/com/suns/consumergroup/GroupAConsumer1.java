...
public class GroupAConsumer1 {
    ...
    public static void main(String[] args) {
        try{
            consumer = new KafkaConsumer<>(KafkaConst.consumerConfig(BusiConst.CONSUMER_GROUP_A, StringDeserializer.class, StringDeserializer.class));
