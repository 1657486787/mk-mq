...
public class GroupBConsumer2 {
    ...
    public static void main(String[] args) {
        try{
            consumer = new KafkaConsumer<>(KafkaConst.consumerConfig(BusiConst.CONSUMER_GROUP_B, StringDeserializer.class, StringDeserializer.class));
