 ...
 * Description: 使用Kafka提供服务，实现（削峰填谷）流量整形 <br>
 * @author mk
 * @Date 2018-12-24 17:31 <br>
 * @version
 */
...
public class ConsumerService {
    ...
    private static ExecutorService executorService = new ThreadPoolExecutor(2,2, 60,TimeUnit.SECONDS,new SynchronousQueue<Runnable>());
