...
2.增加配置
    ...
    2.1生产者
        <!-- 定义producer的参数 -->
            ...
            <!-- 发送监听器bean -->
            <bean id="sendListener" class="com.suns.service.SendListener" />
    ...
    2.2消费者-自动确认
         <!-- 1.定义consumer的参数 -->
            ...
            <!-- 3.定义消费实现类 -->
            <bean id="kafkaConsumerService" class="com.suns.service.KafkaConsumer" />
    ...
    2.3消费者-手工确认
        <!-- 消费者自行确认-1.定义consumer的参数 -->
            ...
            <!-- 消费者自行确认-3.定义消费实现类 -->
            <bean id="kafkaConsumerServiceAck" class="com.suns.service.KafkaConsumerAck" />
