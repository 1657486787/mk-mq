...
/**
 * ClassName: JmsWildCardsConsumer <br>
 * Description:  <br>
 * @author mk
 * @Date 2018-11-29 10:28 <br>
 * @version
 */
public class JmsWildCardsConsumerAllAny {
...
//            destination = session.createQueue("mk.>");//mk.> 或者mk>
            destination = session.createTopic("mk.>");
