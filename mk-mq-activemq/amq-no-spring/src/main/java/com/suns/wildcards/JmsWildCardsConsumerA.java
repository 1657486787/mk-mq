...
/**
 * ClassName: JmsWildCardsConsumerA <br>
 * Description:  <br>
 * @author mk
 * @Date 2018-11-29 11:04 <br>
 * @version
 */
public class JmsWildCardsConsumerA {
...
//            destination = session.createQueue("mk.a.>");//mk.a.>  或者mk.a.*.queue
            destination = session.createTopic("mk.a.>");
