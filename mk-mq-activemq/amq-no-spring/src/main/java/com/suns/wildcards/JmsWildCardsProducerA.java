...
/**
 * ClassName: JmsWildCardsProducerA <br>
 * Description:  <br>
 * @author mk
 * @Date 2018-11-29 11:08 <br>
 * @version
 */
public class JmsWildCardsProducerA {
...
//            destination = session.createQueue("mk.a.wildcards.queue");
            destination = session.createTopic("mk.a.wildcards.topic");
