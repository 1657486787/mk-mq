...
/**
 * ClassName: JmsWildCardsConsumerB <br>
 * Description:  <br>
 * @author mk
 * @Date 2018-11-29 11:04 <br>
 * @version
 */
public class JmsWildCardsConsumerB {
...
//            destination = session.createQueue("mk.b.*.*");//mk.b.>  或者mk.b.*.*
            destination = session.createTopic("mk.b.*.*");
